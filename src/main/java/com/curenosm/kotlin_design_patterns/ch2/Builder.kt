package com.curenosm.kotlin_design_patterns.ch2.builder
...
fun main() {
    ...
    val mailV2 = Mail_V2(listOf("manager@company.com"))
        .title("Ping")
        .message("Hello")
    println(mailV2)

    // When could ever omit the setters declaration
    val mail2 = Mail_V2_1(listOf("hello@mail.com")).apply {
        message = "Hello"
        title = "Apply"
    }
    println(mail2)
    ...
    val mail3 = Mail_V3(
        title = "Hello", message = "There", to = listOf("my@dear.cat"))
